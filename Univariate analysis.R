...
Subset_SRd<-subset(SRSTd,(!is.na(SRSTd[,10])))
cor.test(Subset_SRd$SRd,Subset_SRd$PP)
cor.test(Subset_SRd$SRd,Subset_SRd$LVS)
cor.test(Subset_SRd$SRd,Subset_SRd$ToV)
cor.test(Subset_SRd$SRd,Subset_SRd$SRd)
cor.test(Subset_SRd$PP,Subset_SRd$LVS)
cor.test(Subset_SRd$PP,Subset_SRd$ToV)
cor.test(Subset_SRd$LVS,Subset_SRd$ToV)
cor.test(Subset_SRd$PP,Subset_SRd$PP)
cor.test(Subset_SRd$ToV,Subset_SRd$ToV)

##STd
Subset_STd<-subset(SRSTd,(!is.na(SRSTd[,11])))
cor.test(Subset_STd$STd,Subset_STd$PP)
cor.test(Subset_STd$STd,Subset_STd$LVS)
cor.test(Subset_STd$STd,Subset_STd$ToV)
cor.test(Subset_STd$STd,Subset_STd$STd)
cor.test(Subset_STd$PP,Subset_STd$LVS)
cor.test(Subset_STd$PP,Subset_STd$ToV)
cor.test(Subset_STd$LVS,Subset_STd$ToV)
cor.test(Subset_STd$PP,Subset_STd$PP)
cor.test(Subset_STd$ToV,Subset_STd$ToV)

##CLd
Subset_CLd<-subset(SRSTd,(!is.na(SRSTd[,14])))
cor.test(Subset_CLd$CLd,Subset_CLd$PP)
cor.test(Subset_CLd$CLd,Subset_CLd$LVS)
cor.test(Subset_CLd$CLd,Subset_CLd$ToV)
cor.test(Subset_CLd$CLd,Subset_CLd$CLd)
cor.test(Subset_CLd$PP,Subset_CLd$LVS)
cor.test(Subset_CLd$PP,Subset_CLd$ToV)
cor.test(Subset_CLd$LVS,Subset_CLd$ToV)
cor.test(Subset_CLd$PP,Subset_CLd$PP)
cor.test(Subset_CLd$ToV,Subset_CLd$ToV)
